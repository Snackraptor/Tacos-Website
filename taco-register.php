...
if($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = "INSERT INTO taco_users (username, hashed_password ) ";
...
<div class="card position-absolute top-50 start-50 translate-middle" style="width: 700px;">
    <h1 class="card-title fs-5 mt-4 text-center">CREATE TACO ACCOUNT</h1>
    ...
    <div class="row justify-content-center">
        <form novalidate class="p-5" method="POST">
            ...
            <div class="form-floating mb-4">
                <input type="password" required name="new-password"
                    ...
                    id="new-password" placeholder="Password" value="<?= $new_password ?? ''; ?>">
        ...
        <p class="text-center">Already have an account? <a href="login.php" class="text-dark"><strong>Login
                    Here</a></p>
    </div>
</div>
